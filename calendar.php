...
<div class="nav">
    <table style="width: 100%">
        <tr>
            ...
            <td style="font-size:40px;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
...
for($i=0;$i<6;$i++){
    ...
    for($j=0;$j<7;$j++){
        ...
        if(isset($hoildays[date("m-d",$theDayTime)])){
            echo "<br>{$hoildays[date("m-d",$theDayTime)]}";
        }
        echo "</td>";
